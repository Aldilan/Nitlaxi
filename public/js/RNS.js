...
closeButtons.forEach(function (closeButton) {
    closeButton.addEventListener('click',function (e) {
        modalContainers.forEach(function (modalContainer2) {
            modalContainer2.classList.remove('showModal')
        })
    })
})
